...
Đặc trưng âm học, điểm, tiến độ và hiệu chỉnh chạy cục bộ. Trên iOS, một luồng duy nhất của bộ máy âm thanh gốc đồng thời cấp dữ liệu cho dạng sóng, phân tích âm học cục bộ và nhận dạng giọng nói của hệ thống; các phần của ứng dụng không còn tranh giành micrô. PWA thường thử nhận dạng giọng nói tương thích của trình duyệt trước; trình duyệt hoặc nền tảng có thể xử lý việc đó qua dịch vụ riêng. Trên web iPhone và iPad, ứng dụng chỉ ghi một luồng để dạng sóng và bộ ghi không tranh giành micrô, rồi phiên âm chính đoạn ngắn đó sau khi dừng. Khi nhận dạng của trình duyệt không khả dụng, thất bại hoặc không trả về văn bản, lần thử có thể được gửi tạm thời qua cổng cùng nguồn có giới hạn tần suất tới dịch vụ Whisper riêng. Cổng chỉ nhận đúng đường dẫn phiên âm từ nguồn này, giới hạn kích thước và số yêu cầu đồng thời, không ghi nhật ký hay lưu âm thanh và trả về `Cache-Control: no-store`. Nếu không có phiên âm, dạng sóng vẫn hiển thị nhưng không có điểm nào được hiện hoặc lưu.
