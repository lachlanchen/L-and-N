...
[App Store — US$0,99](https://apps.apple.com/us/app/l-n-speech-practice/id6808872450) · [Google Play — descarga gratuita, compras en la aplicación](https://play.google.com/store/apps/details?id=art.lazying.landn) · [Enlaces oficiales](../docs/public-links.md)
...
Las características acústicas, puntuaciones, progreso y calibración se procesan localmente. En iOS, un único flujo del motor de audio nativo alimenta a la vez la forma de onda, el análisis acústico local y el reconocimiento de voz del sistema; la aplicación no compite consigo misma por el micrófono. La PWA alojada normalmente prueba primero el reconocimiento de voz compatible del navegador; el navegador o la plataforma pueden procesarlo mediante su propio servicio. En la web de iPhone y iPad, la aplicación graba un solo flujo para que la forma de onda y la grabadora no compitan por el micrófono, y transcribe ese mismo clip corto después de detenerse. Si el reconocimiento del navegador no está disponible, falla o no devuelve texto, el intento puede enviarse temporalmente a través de una pasarela del mismo origen y con límite de solicitudes al servicio privado de Whisper. La pasarela solo acepta la ruta exacta de transcripción desde este origen, limita el tamaño y la concurrencia, no registra ni guarda audio y responde `Cache-Control: no-store`. Sin transcripción, la forma de onda permanece visible, pero no se muestra ni se guarda ninguna puntuación.
