...
## TestFlight builds 12-15 (1.0.6), 2026-09-22 and 2026-09-23 — Chinese scoring

- Build 12: syllable-based matching for Mandarin and Cantonese. Build 13: romanized transcripts understood, `yue-Hant-HK` asked of the browser, `yue` asked of the transcription service. Build 14: an attempt is scored from onset and acoustics when no word is recognized, instead of being refused. Build 15 (`9cdc2613-0b8b-4bbe-afad-ee612a789693`): `SFSpeechRecognizer` is built from a locale iOS actually has, `zh-HK` for Cantonese, after it emerged that `yue-HK` returns nil and left Cantonese with no recognizer at all.
- All four are in internal testing and added to `L & N Public Beta`. The external beta review for 15 is blocked only by Apple's one-build-per-train rule while an earlier build finishes review.

## App Store 1.0.5 (build 10), 2026-09-21 — new screenshots, Waiting for Review

- 1.0.4 (build 9) was approved the same day it was submitted and is live. Because Apple locks screenshots on a submitted version, the refreshed listing went out as version 1.0.5 on build 10 (hear-each-word buttons, WebGL fallback): 7 iPhone 6.5" and 7 iPad 13" screenshots uploaded through the API (`store/assets/`), What's New set, review submission `639729e6-b9e4-4118-801d-d3fd6038c9fa` was submitted, then Apple flagged the version **Invalid Binary** on 2026-09-22 because build 10 carries marketing version 1.0.4 while the version is 1.0.5. Fixed the same day: iOS bumped to 1.0.5 build 11 (`release/build11.sh`, IPA SHA-256 `da3888c87d5c894aee060853b09b1ce6e2296aed2ee6c4ffd7c2dac6de71449d`, build id `c2ee7ee4-9350-4a73-812d-c85f4fa2f237`), attached to 1.0.5, the failed submission cancelled and a new review submission `6a136111-63a6-45bf-92dd-9ea0063fdd82` submitted; build 11 also added to TestFlight (internal + public beta).
