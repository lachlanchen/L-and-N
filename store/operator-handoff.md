...
- Exam lengths (2026-09-19, latest): web release `428b118f…` (commit `142f875`), Android internal `7 (1.0.2)`, iOS build 6 in the internal group (delivery `ca832a05-213c-4c71-a73f-738f4c12fc7f`, VALID); hashes in `store/artifacts/native-release-1.0.2.json` `lengthsRelease`. Public beta still waits on build 4's review.
