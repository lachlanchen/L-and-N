...
- Hear-word test builds (2026-09-21, latest): Android internal 13 (both Play apps) and iOS TestFlight build 10 carry the hear-each-word buttons (commit `c02d05f`); free-app production 13 sent for review on 2026-09-21 (11 is live); Pro production and the App Store submission stay on 11 / build 9 until their reviews finish.
