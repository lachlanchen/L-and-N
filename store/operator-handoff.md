...
- Kept takes 1.0.3 (2026-09-20, latest): web release `eac4139f…` (commit `1eeb10a`), Android internal `11 (1.0.3)`, production 11 submitted for both Play apps, iOS build 8 in TestFlight and App Store 1.0.3 waiting for review. Takes live in IndexedDB on the device only (`src/lib/takes.ts`).
