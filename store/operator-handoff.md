...
- Hear-word test builds (2026-09-21, latest): Android internal 13 (both Play apps) and iOS TestFlight build 10 carry the hear-each-word buttons (commit `c02d05f`); production and the App Store submission stay on 12 / build 9 until the pending reviews finish.
